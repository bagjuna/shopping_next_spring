package org.zerock.apiserver.domain.product.util;
	...
	public List<String> upload(MultipartFile[] files) {
		...
		for (MultipartFile file : files) {
			...
			try (InputStream inputStream = file.getInputStream()) {
				...
				ImmutableImage thumbnailImage = image.scaleToWidth(thumbWidth,
					ScaleMethod.Bicubic); // 너비 300px에 맞춰 비율 유지
