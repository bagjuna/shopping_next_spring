        ...
        <div className="container mx-auto p-6 bg-gray-50 min-h-screen">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
                <form action={putAction} className="space-y-6">
                    {/* 상품 번호는 수정 불가능하도록 표시 */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700">PNO:</label>
                        <input
                            type="text"
                            name='pno'
                            defaultValue={pno}
                    ...
                    {/* 상품명 입력 필드 */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700">PNAME:</label>
                        <input
                            type="text"
                            name='pname'
                            defaultValue={pname}
                    ...
                    {/* 기존 이미지 목록 */}
                    <div>
                        <h3 className="text-lg font-semibold mb-2 text-gray-700">기존 이미지</h3>
