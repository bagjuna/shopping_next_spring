    ...
    return (
        <div className="flex flex-col items-center justify-center p-6 bg-gray-100 min-h-screen">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                <h1 className="text-2xl font-bold text-center text-gray-800">새 상품 등록하기</h1>
                ...
                <form action={action} className="space-y-4">
                    <div>
                        <label htmlFor="pname" className="block text-sm font-medium text-gray-700">상품 이름</label>
                        <input
                            type='text'
                            id="pname"
                            name='pname'
                    ...
                    <div>
                        <label htmlFor="price" className="block text-sm font-medium text-gray-700">상품 가격</label>
                        <input
                            type='number'
                            id="price"
                            name='price'
                    ...
                    <div>
                        <label htmlFor="files" className="block text-sm font-medium text-gray-700">상품 이미지</label>
                        <input
                            type='file'
                            id="files"
                            name='files'
                    ...
                    <div className="pt-2">
                        {isPending ? (
                            <div
                                className="w-full py-2 text-center text-white bg-blue-400 rounded-md transition-colors duration-200">
                                처리 중...
                            </div>
                        ) : (
                            <button
